...
describe('Coinbase Document Services', function () {
  ...
  describe('Dynamic document creation / Directories mocked (.minerid-client, .keystore & .revocationkeystore)', function () {
    ...
    it('can create miner-info OP_RETURN script for "unittest"', async () => {
      assert.strict.deepEqual(await coinbaseDocService.createMinerInfoOpReturn('unittest', 100),'')
    })

    it('can create coinbase OP_RETURN script', async () => {
      assert.strict.deepEqual(mi.createCoinbaseOpReturnScript('f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16').toHex(), '006a04601dface010020169e1e83e930853391bc6f35f605c6754cfead57cf8387639d3b4096c54f18f4')
    })
