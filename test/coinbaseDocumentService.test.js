...
describe('Coinbase Document Services', function () {
  ...
  describe('Dynamic document creation / Directories mocked (.minerid-client, .keystore & .revocationkeystore)', function () {
    ...
    it('can create coinbase OP_RETURN script', async () => {
      const createCoinbaseOpReturnScript = coinbaseDocService.__get__('createCoinbaseOpReturnScript')
      assert.strict.deepEqual(createCoinbaseOpReturnScript('f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16').toHex(), '006a04601dface0020f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16')
    })
    it('can create coinbase2 for "unittest"', async () => {
      const createCoinbase2 = coinbaseDocService.__get__('createCoinbase2')
      assert.strict.deepEqual(await createCoinbase2('unittest', 'f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16','ffffffff011a0a5325000000001976a9145deb9155942e7d38febc15de8870222fd24d080e88ac00000000'), 'ffffffff021a0a5325000000001976a9145deb9155942e7d38febc15de8870222fd24d080e88ac000000000000000029006a04601dface0020f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e1600000000')
    })
  })
